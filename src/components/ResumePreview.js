      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Virat Kohli"}
              </Heading>
              <Text color={"gray.500"}>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "viratkohli@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+91-6294468299"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Siliguri"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={"medium"}>
                        {degree ? degree : "XYZ Computer Engineering"}
                      </Text>
                      <Text fontSize={"sm"}>
                        {school ? school : "XYZ College of Engineering"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        ...
                        <Text>{grade ? grade : "7.5 CGPA"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
